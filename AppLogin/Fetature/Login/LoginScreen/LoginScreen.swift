...
class LoginScreen: UIView {
    ...
    lazy var emailTextField: UITextField = {
        ...
        tf.layer.borderColor = UIColor.white.cgColor  //borderColor espera um tipo CGColor, deste modo precisamos converter usando .cgColor
        return tf
    }()
    ...
    lazy var subLoginImageView: UIImageView = {
        ...
        image.contentMode = .scaleAspectFill   // Escolha do aspecto
        return image
    }()
    ...
    lazy var signMetamaskLabel: UILabel = {
        let label = UILabel()
        label.translatesAutoresizingMaskIntoConstraints = false
    ...
    private func addEleements() {
        ...
        signInMetamaskView.addSubview(signMetamaskImageView)
        signInMetamaskView.addSubview(signMetamaskLabel)
    }
